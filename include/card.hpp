...
class visit_from_the_detective : public perk_card{
    ...
    public:
    visit_from_the_detective(int count){ this->count = count; name="isit_from_the_detective"; }
    void play_perk(Monster*)override;

};
class break_of_dawn : public perk_card{
    public:
    break_of_dawn(int count){ this->count = count; name="break_of_dawn";}
...
class overstock : public perk_card{
    ...
    public:
    overstock(int count){ this->count = count; name="overstock";}
    void play_perk(std::multimap<std::string,place> & places ) override;
...
class late_into_the_night : public perk_card{
    ...
    late_into_the_night(int count){ this->count = count; name="late_into_the_night";}
...
class repel : public perk_card{
    repel(int const){ this->count = count;name="repel";}
...
class hurry : public perk_card{
    ...
    hurry(int count){ this->count = count;name="hurry";}
